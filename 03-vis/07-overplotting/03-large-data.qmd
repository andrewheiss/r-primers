...
Boxplots efficiently summarize data, which make them a useful tool for large data sets. In the [boxplots tutorial](/03-viz/05-counts.qmd), you learned how to use `cut_width()` and the group aesthetic to plot multiple boxplots for a continuous variable.
